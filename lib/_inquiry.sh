...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link da sua instalção TicketPRESS que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador TicketPRESS, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar TicketPRESS\n"
  printf "   [1] Atualizar TicketPRESS\n"
  printf "   [2] Deletar TicketPRESS\n"
  printf "   [3] Bloquear TicketPRESS\n"
  printf "   [4] Desbloquear TicketPRESS\n"
  printf "   [5] Alter. dominio TicketPRESS\n"
  printf "\n"
  read -p "> " option
